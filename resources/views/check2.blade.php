            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{route('checkcompare2.form')}}" method="post">
                                    @method('post')
                                    @csrf
                                    ...
                                    @foreach($dataForm['products'] as $p)
                                        ...
                                        <div class="form-group">
                                            <label for="p_compare{{$i}}">{{$p['p_name']}} (จำนวนที่เช็คในรอบแรก : {{$p['p_compare1']}})</label>
                                            <input type="number" name="p_compareProduct2_{{$i}}" id="p_compare{{$i}}" class="form-control">
                                        </div>
